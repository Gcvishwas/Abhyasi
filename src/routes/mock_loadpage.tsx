        ...
        <div className='flex flex-col w-full gap-8 py-5'>
            ...
            <Alert className='bg-yellow-100/50 border-yellow-200 p-4 rounded-lg flex items-start gap-3 -mt-3'>
                ...
                <div>
                    ...
                    <AlertTitle className='text-yellow-800 font-semibold'>Important info</AlertTitle>
                    <AlertDescription className='text-sm text-yellow-700 mt-2'>
                        Please enable your webcam and microphone to proceed with the mock interview. This helps simulate a real interview environment and ensures all features work as intended.{" "}
                        <br />
                        <br />
