      ...
      <Container>
        <div className="my-8">
          ...
          <p className="mt-2 text-center md:text-left text-gray-500 ">
            Practice interviews to simulate real-world scenarios and prepare
            effectively.
            <span className="hidden md:block position:absolute">
              Engage in interactive mock interviews to refine your responses,
              enhance communication skills, and gain valuable insights through
              instant feedback. Whether you're gearing up for technical,
              behavioral, or situational interviews, this tool is designed to
              build your confidence and readiness for success.
            </span>
          </p>
        </div>
        ...
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[420px] drop-shadow-md relative">
          <img
            src="/assets/img/Intervierobot.jpg"
            alt=""
          ...
          <div className="md:block absolute bottom-4 md:right-4  w-80 px-4 py-2 rounded-md md:bg-white/70 text-gray-600 text-sm font-serif backdrop-blur-none">
            <h2 className="hidden md:block text-neutral-800 font-semibold">
              Developer
            </h2>
            <p className="hidden md:block ktext-sm text-neutral-600">
              You can practice coding interviews with AI. It will help you to
              improve your coding skills and get ready for the real world.
            </p>
